...
public class ListFiliereActivity extends AppCompatActivity {
    ...
    private String loadUrl = "http://192.168.1.141:8082/api/v1/filieres";
    ...
    private void deleteFiliere(final int position) {
        ...
        int filiereId = filiereToDelete.getId();
        Log.d("Filiere ID", "ID de la filière à supprimer : " + filiereId);// Assurez-vous d'avoir une méthode getId() dans votre classe Filiere pour obtenir l'identifiant de la filière à supprimer
        String url = "http://192.168.1.141:8082/api/v1/filieres/" + filiereId; // Remplacez ceci par l'URL de votre API pour supprimer une filière
