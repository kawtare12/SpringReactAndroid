...
public class ListRoleActivity extends AppCompatActivity {
    ...
    private String loadUrl = "http://192.168.1.141:8082/api/role";
    ...
    private void deleteRole(final int position) {
        ...
        String url = "http://192.168.1.141:8082/api/role/" + roleId; // Remplacez ceci par l'URL de votre API pour supprimer une filière
